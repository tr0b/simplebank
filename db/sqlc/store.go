...
// Store provides all functions to execute db queries and transactons
...
// Creates a transfer record, add account entries, and updates accounts balances within a single database transaction
